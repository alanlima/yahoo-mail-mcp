...
Do NOT use `mcp.example.com` itself as the origin because that would create a DNS loop after Route 53 points the hostname to CloudFront.
...
7. change the configured Route 53 MCP hostname
