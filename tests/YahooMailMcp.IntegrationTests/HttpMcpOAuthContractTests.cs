...
public sealed class HttpMcpOAuthContractTests : IClassFixture<HttpMcpOAuthContractTests.OAuthApplicationFactory>
{
    ...
    {
        public const string Authority = "https://login.microsoftonline.com/b16c65ab-9711-44cd-abf1-24e6180a4609/v2.0";
        public const string Audience = "7553b3c9-f602-42a8-b5fe-8a54af0dd3af";
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureAppConfiguration((_, configuration) =>
            {
                configuration.AddInMemoryCollection(new Dictionary<string, string?>
                {
                    ...
                    ["Mcp:OAuth:TenantId"] = "b16c65ab-9711-44cd-abf1-24e6180a4609",
